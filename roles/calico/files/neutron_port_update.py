#!/usr/bin/env python
# This script updates the allowed address pairs with the 'neutron port-update' command.
# This is required by Calico in CiscoCloud, otherwise BGP will not be working.
# We query OpenStack API directly to prevent installing any dependencies 
# such as python-neutronclient.
#
